# -*- coding: utf-8 -*-
{
    'name': "Pro QA Bug Management",
    'summary': "Enterprise QA Bug Tracking, Assignment, Dashboards, and Analytics",
    'description': """
        Next-level QA Bug Management for Odoo 18: analytics, kanban, dashboards, team assignment, notifications, and more.
    ...
    'contributors': [
        "Md Abir Hassan <https://www.linkedin.com/in/abirhassan2/>"
    ],
    'depends': [
        'base',
        'project',
